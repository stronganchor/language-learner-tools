...
- Large exact Progress selections use that bounded planner for Learn, Practice, Listen, Gender, and Self Check alike. Hydrate only the first capped chunk at startup; Practice and Listen continue chunks inside one pre-results logical session, while Learn, Gender, and Self Check retain explicit results-stage continuation.
