    ...
    return [
        'core-runtime-data-model' => [
            ...
            'invariants' => [
                ...
                'Learner-registration option updates use one always-loaded synchronizer; multisite transitions may toggle only user registration while preserving the existing site-registration state.',
                'Public authentication and registration admission uses shared atomic fixed-window counters; a successful login refunds only its own reservation, raw credentials are byte-bounded before hashing, and username collision search remains one bounded query.',
            ],
            'sources' => [
            ...
            'tests' => [
                ...
                'tests/Integration/LoginWindowRegistrationTest.php',
                'tests/Integration/MultisiteRegistrationAndMaintenanceTest.php',
        ...
        'wordset-vocab-manager' => [
            ...
            'signals' => [
                ...
                'vocab lesson timestamp aggregate',
                ...
                'per-category recorder summary cache',
                'recorder summary prewarm',
                'll_tools_wordset_page_get_recorder_queue_cached_overview',
                'll_tools_wordset_page_schedule_recorder_queue_summary_warmup',
                'll_tools_word_audio_parent_category_cache_bumped',
                'll_tools_recorder_config_saved',
            ...
            'invariants' => [
                ...
                'Complete stored manual category orders skip lesson reads. Missing categories use 200-ID SQL aggregate batches with first category-meta semantics and deterministic local-date/ID selection of the UTC timestamp; never hydrate every published lesson to build the baseline.',
                ...
                'Enabled vocab-lesson wordsets resolve through one set-based existing-term query that preserves configured order and fails open without read-time writes; wordset create/delete mutations own physical stale-ID pruning under the auto-sync suppression guard.',
                ...
                'Frontend Copy/Split Word retains recordings by default. Explicit moves require current source and recording access, and saved per-user request receipts prevent repeating an ambiguous mutation; partial copies remain reviewable.',
                'Copy/Split is available in the shared word editor popup and manager table. Popup triggers carry their wordset nonce; unsaved edits block copying, the nested native dialog owns keyboard focus, and completion removes moved recordings and invalidates detached editor markup.',
            ...
            'sources' => [
                ...
                'includes/lib/word-copy.php',
                'includes/lib/recording-metadata.php',
                ...
                'js/word-copy-dialog.js',
                'css/word-copy-dialog.css',
                'js/vocab-lesson*.js',
            ...
            'tests' => [
                ...
                'tests/Integration/WordCopySplitTest.php',
                'tests/Integration/RecordingMetadataWriteTest.php',
                'tests/Integration/SplitWordReturnFlowTest.php',
                'tests/e2e/specs/word-copy-dialog.spec.js',
                'tests/e2e/specs/word-copy-popup.spec.js',
                'tests/Integration/WordCopyPopupTest.php',
                'tests/e2e/specs/frontend-recording-tools-wp.spec.js',
                'tests/e2e/fixtures/seed-frontend-recording-tools.php',
                ...
                'tests/Integration/WordsetRecorderQueueOverviewResourceTest.php',
        ...
        'recording-media-transcription' => [
            'description' => 'Audio recording, media admin/imports, IPA/transcription manager, matching, WebP optimization, and media helpers.',
            'load_when' => 'A change touches recordings, audio uploads, transcription rows, IPA matching, generated media assignment, or WebP optimizer queues and visibility.',
            'signals' => [
                'audio recorder',
                'recording interface',
                'audio upload',
                ...
                'prompt audio',
                'WebP optimizer',
                'optimizer viewer scope',
                'optimizer queue cache',
            ],
            'invariants' => [
                ...
                'Bulk and individual recording deletions share one UI mutation fence, use bounded concurrency and deadlines, and reconcile ambiguous retries through a short-lived capability-checked deletion receipt.',
                'Recording deletion receipts retain pending, post-deleted, retained cleanup-failure, and terminal phases plus uploads-root-safe cleanup paths; bounded scheduled retries finish file and parent cleanup before terminal publication.',
                'IPA Keyboard lesson links query only the bounded requested category IDs (100 default, 250 hard maximum) instead of scanning every published vocabulary lesson.',
                'WebP optimizer queues, focused rows, summaries, and filter labels require current post, attachment, wordset-owner, and category visibility before resolving media details. Queue cache identity includes viewer capabilities, managed wordsets, and privacy epochs; discard an index if its scope changes during construction.',
            ],
            'sources' => [
                'includes/shortcodes/audio-recording-shortcode.php',
                ...
                'js/wordset-transcription-review.js',
                'js/recording-history.js',
                'css/wordset-transcription-review.css',
                'css/recording-history.css',
                'js/image-webp-optimizer-admin.js',
                'css/recording-interface.css',
                'css/audio-*.css',
                'css/ipa-keyboard-admin.css',
                'css/image-webp-optimizer-admin.css',
            ],
            'tests' => [
                'tests/Integration/Audio*Test.php',
                'tests/Integration/Recording*Test.php',
                'tests/Integration/Ipa*Test.php',
                'tests/Integration/WordsetTranscriptionReviewTest.php',
                'tests/Integration/PromptAudioImportAdminTest.php',
                'tests/Integration/ImageWebpOptimizerAdminTest.php',
                'tests/e2e/specs/audio-*.spec.js',
                'tests/e2e/specs/transcription-manager-*.spec.js',
                'tests/e2e/specs/wordset-transcription-review.spec.js',
                'tests/e2e/specs/recording-history.spec.js',
                'tests/e2e/specs/frontend-recording-tools-wp.spec.js',
                'tests/e2e/fixtures/seed-frontend-recording-tools.php',
            ],
        ],
        'automation-import-sync' => [
            ...
            'load_when' => 'A change touches REST automation, import previews, metadata plans, site sync snapshots, remote apply flows, CLI resume files, or server-side job ownership and recovery.',
            'signals' => [
                'automation rest',
                'site sync',
                'snapshot',
            ...
            'invariants' => [
                ...
                'Import and metadata-plan steps use connection-owned MySQL advisory locks keyed by canonical job option identity. Read authoritative state after admission, fence checkpoint SQL by exact stored bytes plus CONNECTION_ID/IS_USED_LOCK, and release only the exact owner; unavailable locks or changed connections fail closed.',
                'Persist pending_step before import or metadata side effects and clear it only with the verified final checkpoint. A retained marker means uncertain applied work and blocks automatic replay and discard; import snapshots expose recoveryRequired with canResume/canDiscard false, and the UI offers Reload for readback.',
                'Process, discard, and import expiry cleanup share job ownership and revalidate stored status; import discard deletes state through the same exact-value SQL ownership fence. Error responses read current persisted state; do not report successful creation, completion, or discard when checkpoint storage fails.',
                'Bulk word-set CLI resume version 2 binds site/blog, wordset, field/value, and normalized scope filters to an operation fingerprint and freezes target_ids before mutation. Reject corrupt or mismatched existing state and legacy processed-only files; never reapply offset/limit to the shrinking remaining match set.',
            ],
            'sources' => [
            ...
            'tests' => [
                ...
                'tests/Integration/MetadataUpdate*Test.php',
                'tests/Integration/MutationJobReliabilityTest.php',
                'tests/Integration/CliResumePlanTest.php',
        ...
        'dictionary-i18n-cache' => [
            ...
            'invariants' => [
                ...
                'AI crawler exports must stay bounded and include anonymous public content only. Check raw privacy predicates rather than access helpers with user ID zero, exclude password-bearing posts regardless of cookies, and omit private linked labels and dictionary-letter fallback rows; discard a build when its cache generation changes.',
            ],
            'sources' => [
        ...
        'offline-games-content-progress' => [
            'description' => 'Offline app export/sync, wordset games, user progress, content lessons, interlinear content, teacher classes, formative reporting, and LMS assignment/delivery connectors.',
            'load_when' => 'A change touches offline bundles, wordset games, progress/study rows, content lessons, teacher classes, quiz results, server-scored assignments, Google Classroom, or LMS integration.',
            'signals' => [
                'offline app',
                'offline export',
                'offline export lock',
                ...
                'space shooter',
                'user progress',
                'event payload byte limit',
                'mode_session_complete',
                'practice_first_try',
                'practice result query batch',
                'quiz result',
                'teacher gradebook',
                'server-scored assignment',
                'assignment attempt',
                'Google Classroom',
                'Google OAuth',
                'CourseWork API',
                'grade delivery worker',
                'LMS integration',
                'LTI 1.3',
                ...
                'learner settings save failure',
                'dotless i IPA migration',
                'content lesson',
                ...
                'display_prereq_tree',
                'interlinear',
                'text document review note',
                'compare and set review note',
                'teacher class',
                'privacy retention',
                'game launch',
            ],
            'invariants' => [
                ...
                'Offline export is an explicit bounded batch job. Acquire native flock before loading state, retain lock files outside deletable job directories, and make deletion contend with the same ownership; expired continuation cleanup retries after releasing its own handle.',
                'Offline export checkpoints use validated same-directory temporary-file replacement. Persist step_pending before append work; if its final checkpoint is missing, fail visibly and require a new export rather than replaying a possibly appended fragment. A retry after a successfully checkpointed completion returns the same result without writing again.',
                'Native bundle preparation validates and repairs a staged bundle before publishing bundle/config/state with rollback on publication errors. Reject overlapping source/workspace paths and nested directory symlinks or junctions; this rollback is not a crash-atomic transaction across all three destinations. Only named first-party builder entry points belong in this pack; native/vendor trees remain a separate review boundary.',
                ...
                'Progress/snapshot/goals/recommendation/analytics request collections must pass byte, count, and shape guards before JSON decoding, mapping, or query work; oversized batches are rejected rather than truncated.',
                'Individual progress-event payloads must pass the byte, node, and depth budget before sanitization or persistence; bounded legacy keys remain compatible.',
                'Client progress events require a stable caller-supplied UUID so retries cannot bypass ledger deduplication; only server-originated event creation may generate one.',
                'The one-time dotless-i recording_ipa correction is a leased WP-Cron keyset migration with durable cursor state and coalesced wordset-map rebuilds; public init only schedules it.',
                ...
                'Teacher-class deletion publishes an exact-owner class lease before its roster barrier; membership writers take user then class locks and recheck the lease before committing either side.',
                'Client-reported Practice results are formative: persist only the canonical bounded mode-session result contract, compute percentages server-side, and read only paged class learners in small payload-bounded query batches.',
                'Progress-report aggregate, ID, count, and user-query failures remain typed; teacher rows and summaries render unavailable rather than converting incomplete reads to zero.',
                'Text-document review-note autosave is one-in-flight/latest-queued and the shared meta array is updated with exact-value CAS; stale same-key bases return a visible conflict rather than overwriting.',
                'LMS grade passback requires server-verifiable assignments and attempts plus a durable after-commit outbox; never perform outbound delivery in the learner-progress transaction.',
                'Published assignment revisions are immutable, answer correctness is derived from the frozen server manifest, and the client never supplies a score or correctness flag.',
                'External grade delivery is revision-pinned, deduplicated, lease-owned, stale-grade suppressed, bounded to twenty rows, and scheduled only after the owning authoritative grade transaction commits; repair and throttled runtime recovery re-arm stranded rows.',
                'Direct external-identity and recipient writers join the assignment transaction, lock the learner row, current-read both privacy fences, and re-read authoritative mappings before mutation.',
                'Google OAuth refresh credentials use authenticated configuration-key encryption; Google origins are fixed, OAuth state/PKCE are one-use with bounded scheduled retention, and Classroom writes remain disabled until an exact provider adapter and authoritative grade mappings pass sandbox tests.',
                'Account deletion uses atomic per-user tombstones through the post-delete hook, fences late LMS writes, removes local rows without provider callbacks, and keyset-resumes bounded overflow; privacy storage failures return explicit errors.',
                'Privacy erasure preserves externally owned simplefavorites data but records an LL-owned marker that prevents its legacy lesson completions from being replayed.',
                'A Google grade write must bind the authoritative local learner to both the expected Google user ID and exact submission before PATCH and verify the same identity in the response.',
            ],
            'sources' => [
                ...
                'offline-app-builder/README.md',
                'offline-app-builder/scripts/prepare-bundle.mjs',
            ...
            'tests' => [
                ...
                'tests/Integration/UserStateResourceGuardTest.php',
                'tests/Integration/WordGridIpaLanguageCasingTest.php',
                'tests/Integration/ContentLesson*Test.php',
                'tests/Integration/LegacyContentLessonMigrationTest.php',
                'tests/Integration/TeacherClassesTest.php',
                'tests/Integration/UserProgressPracticeResultTest.php',
                'tests/Integration/InternalReviewNotesTest.php',
                'tests/Integration/Lms*Test.php',
                'tests/Integration/GoogleClassroom*Test.php',
                'tests/e2e/specs/practice-option-constraints.spec.js',
                'tests/e2e/specs/offline-*.spec.js',
                'tests/e2e/specs/wordset-offline-export-job-progress.spec.js',
                'tests/e2e/specs/wordset-study-save-recovery.spec.js',
                'offline-app-builder/tests/builder-hardening.test.mjs',
        ...
        'performance-benchmark' => [
            ...
            'invariants' => [
                ...
                'Manual category ordering skips lesson reads for complete saved orders and queries only missing categories in 200-ID aggregate batches without priming lesson posts or metadata.',
            ],
            'sources' => [
                ...
                'tests/Integration/WordsetManualOrderingResourceTest.php',
            ],
            'tests' => [
                'tests/e2e/specs/performance-benchmark.spec.js',
                'tests/e2e/specs/performance-benchmark-contracts.spec.js',
