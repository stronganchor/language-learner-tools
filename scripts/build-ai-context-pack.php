    ...
    return [
        ...
        'wordset-vocab-manager' => [
            ...
            'invariants' => [
                ...
                'Logged-in broad or progress-filtered non-learning selections use one capped ID-only launch plan and candidate-specific hydration; 429 and hydration failures clear the loader instead of draining selected categories or retrying indefinitely.',
