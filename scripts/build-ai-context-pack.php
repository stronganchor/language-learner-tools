    ...
    return [
        ...
        'offline-games-content-progress' => [
            ...
            'invariants' => [
                ...
                'Client-reported Practice results are formative: persist only the canonical bounded mode-session result contract, compute percentages server-side, and read only paged class learners with bounded event scans.',
