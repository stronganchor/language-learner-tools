...
function ll_tools_context_pack_definitions(): array
{
    return [
        ...
        'offline-games-content-progress' => [
            'description' => 'Offline app export/sync, wordset games, user progress, content lessons, interlinear content, teacher classes, and formative quiz/LMS reporting.',
            'load_when' => 'A change touches offline bundles, wordset games, progress/study rows, content lessons, teacher classes, quiz results, or LMS integration.',
            'signals' => [
                'offline app',
                'offline export',
                'offline sync',
