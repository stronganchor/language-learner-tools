    ...
    return [
        'core-runtime-data-model' => [
            ...
            'invariants' => [
                ...
                'Before user-meta repair, preflight every required category mapping; global goal lists preserve the bounded already-materialized family expansion without crossing preferred wordsets, and exact-prev-value CAS failures must not advance the cursor.',
        ...
        'wordset-vocab-manager' => [
            ...
            'invariants' => [
                ...
                'Recorder manager and recording-shortcode overviews share the cached structural category catalog and authenticated summary pipeline; render six initial manager summaries, request at most twenty per batch, and remove resolved-empty categories.',
                ...
                'Focused recorder queues page canonical word/image candidates, legacy missing-audio rows, and prompt cards after eligibility; every raw scan is bounded and resumable.',
                'Client recorder cursors are expiring HMAC tokens bound to viewer, recorder, wordset, category, filters, requested page, page size, and structural/type epochs; require canonical unpadded Base64URL segments, never trust raw request IDs or offsets, and let the stable cursor survive expected audio/hide mutations between batches.',
        ...
        'performance-benchmark' => [
            ...
            'invariants' => [
                ...
                'Recorder-enabled manifests require admin credentials, six initially actionable categories, exact final category coverage, and bounded 20-category request counts.',
