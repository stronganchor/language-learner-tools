    ...
    return [
        ...
        'wordset-vocab-manager' => [
            ...
            'invariants' => [
                ...
                'Client recorder cursors are expiring HMAC tokens bound to viewer, recorder, wordset, category, filters, requested page, page size, and structural/type epochs; never trust raw request IDs or offsets, and let the stable cursor survive expected audio/hide mutations between batches.',
