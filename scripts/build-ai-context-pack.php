...
function ll_tools_context_pack_definitions(): array
{
    return [
        ...
        'wordset-vocab-manager' => [
            'description' => 'Wordset pages and buttons, lazy cards, search, editor/settings UI, recorder queue overviews, vocab lessons, word grid, and bounded ranked-word lists.',
            'load_when' => 'A change touches public wordset pages or buttons, category shells, search, recommendations, editor rows, recorder queue overview/settings, vocab lesson cards, or a ranked reference collection.',
            'signals' => [
                'wordset page',
                'wordset manager',
                'category shell',
            ...
            'invariants' => [
                ...
                'Logged-in broad or progress-filtered non-learning selections use one capped ID-only launch plan and candidate-specific transport hydration; practice appends those chunks serially inside one logical session before final results, while 429 and hydration failures clear the loader and retain the unchanged pending chunk for explicit retry.',
