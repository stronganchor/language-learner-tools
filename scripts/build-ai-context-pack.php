    ...
    return [
        ...
        'wordset-vocab-manager' => [
            ...
            'invariants' => [
                ...
                'Recorder manager and recording-shortcode overviews share the cached structural category catalog and authenticated summary pipeline; the manager starts with one three-category request and advances one default six-category batch per Load more click or fresh sentinel entry, while the shortcode shows at most three identity-free shells plus an overflow cue. Keep the twenty-category operator cap explicit and remove resolved-empty categories.',
