...
final class AssetEnqueueTest extends LL_Tools_TestCase
{
    ...
    public function test_request_needs_public_assets_true_for_wordset_buttons_shortcode_page(): void
    {
        $page_id = self::factory()->post->create([
            'post_type' => 'page',
            'post_status' => 'publish',
            'post_title' => 'Wordset Buttons Page',
            'post_content' => '[ll_wordset_buttons]',
        ]);
