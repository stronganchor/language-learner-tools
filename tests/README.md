...
- `tests/e2e/specs/wordset-pages-listening-launch.spec.js`
  - Verifies wordset page launch actions can open Listening mode with the
    ...
    and no intermediate Continue/Next Set action; bounded non-practice modes
    retain their explicit results-stage continuation. Direct specific-wrong-answer-only
