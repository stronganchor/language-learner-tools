...
- `tests/e2e/specs/maintenance-doc-contracts.spec.js`
  - Verifies source/docs contracts that are cheap to check in the Playwright runner, including registered public shortcodes being documented in `README.md`, high-confidence hardcoded UI-string contexts using WordPress i18n wrappers, and wordset-games public JS avoiding duplicated English `i18n` fallback strings.
