...
- Known E2E coverage gaps still worth adding:
  ...
  - Deeper Line Up/Unscramble interaction and completion flows plus Speaking Practice recording/API behavior.
...
- `tests/e2e/specs/wordset-games-space-shooter.spec.js`
  - Verifies the wordset games page bootstraps availability correctly, covers Line Up and Unscramble startup into their dedicated sequence stage, checks Word Stack layout/fall-speed regressions, and verifies Space Shooter/Bubble Pop runtime behavior and progress events.
