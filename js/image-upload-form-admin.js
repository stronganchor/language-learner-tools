(function ($) {
    ...
    $(function () {
        ...
        $('[data-ll-image-upload-form]').each(function () {
            ...
            $form.on(
                'change input',
                'input[name="ll_wordset_scope_mode"], [data-ll-single-wordset], [data-ll-multi-wordset], input[name="ll_category_mode"], [data-ll-existing-category], [data-ll-new-category-title], [data-ll-new-category-prompt], [data-ll-new-category-option]',
                function () {
                    syncFormState($form);
                }
            );
