...
function ll_tools_wordset_page_render_priority_focus_icon(string $focus, string $class = 'll-wordset-priority-option__icon'): string {
    ...
    if ($focus === 'starred') {
        return '<span class="' . esc_attr($class) . '" aria-hidden="true">'
            ...
            . '<path d="M32 8 L39.9 24.2 L58 26.6 L45 39.1 L48.3 56.8 L32 48.1 L15.7 56.8 L19 39.1 L6 26.6 L24.1 24.2 Z" fill="#facc15" stroke="#111827" stroke-width="3.2" stroke-linejoin="round"></path>'
            . '</svg>'
            . '</span>';
    }
    if ($focus === 'hard') {
        return '<span class="' . esc_attr($class) . '" aria-hidden="true">'
            . '<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">'
            . '<path d="M32 8 L58 52 H6 Z" fill="#f97316" stroke="#7c2d12" stroke-width="3.4" stroke-linejoin="round"></path>'
            . '<line x1="32" y1="23" x2="32" y2="37" stroke="#1f2937" stroke-width="5" stroke-linecap="round"></line>'
            . '<circle cx="32" cy="45" r="3.2" fill="#1f2937"></circle>'
            . '</svg>'
            . '</span>';
    }
    return '';
...
function ll_tools_render_wordset_page_content($wordset, array $args = []): string {
    ...
    wp_localize_script('ll-wordset-pages-js', 'llWordsetPageData', [
        ...
        'i18n' => [
            ...
            'analyticsHard' => __('Difficult', 'll-tools-text-domain'),
                    ...
                    <div class="ll-wordset-progress-panel" data-ll-wordset-progress-panel="words" hidden>
                        ...
                        <div class="ll-wordset-progress-table-wrap">
                            <table class="ll-wordset-progress-table ll-wordset-progress-table--words">
                                <thead>
                                    <tr>
                                        <th scope="col"><span class="screen-reader-text"><?php echo esc_html__('Starred', 'll-tools-text-domain'); ?></span></th>
                                        ...
                                        <th scope="col" data-ll-wordset-progress-sort-th="difficulty" data-mobile-label="<?php echo esc_attr__('Difficulty', 'll-tools-text-domain'); ?>" aria-sort="none">
                                            <div class="ll-wordset-progress-th-controls">
                                                ...
                                                <button type="button" class="ll-wordset-progress-sort" data-ll-wordset-progress-sort="difficulty">
                                                    <span><?php echo esc_html__('Difficulty Score', 'll-tools-text-domain'); ?></span>
                                                    <span class="ll-wordset-progress-sort-indicator" aria-hidden="true"></span>
                                                </button>
                                            </div>
                                        ...
                                        <th scope="col" data-ll-wordset-progress-sort-th="seen" data-mobile-label="<?php echo esc_attr__('Seen', 'll-tools-text-domain'); ?>" aria-sort="none">
                                            <div class="ll-wordset-progress-th-controls">
                                                ...
                                                <button type="button" class="ll-wordset-progress-sort" data-ll-wordset-progress-sort="seen">
                                                    <span><?php echo esc_html__('Seen', 'll-tools-text-domain'); ?></span>
                                                    <span class="ll-wordset-progress-sort-indicator" aria-hidden="true"></span>
                                                </button>
                                            </div>
                                        ...
                                        <th scope="col" data-ll-wordset-progress-sort-th="wrong" data-mobile-label="<?php echo esc_attr__('Wrong', 'll-tools-text-domain'); ?>" aria-sort="none">
                                            <div class="ll-wordset-progress-th-controls">
                                                ...
                                                <button type="button" class="ll-wordset-progress-sort" data-ll-wordset-progress-sort="wrong">
                                                    <span><?php echo esc_html__('Wrong', 'll-tools-text-domain'); ?></span>
                                                    <span class="ll-wordset-progress-sort-indicator" aria-hidden="true"></span>
                                                </button>
                                            </div>
        ...
        <?php else : ?>
                ...
                <header class="ll-wordset-hero">
                    ...
                    <div class="ll-wordset-hero__tools">
                        <a
                            ...
                            aria-label="<?php echo esc_attr(sprintf(__('Hidden categories: %d', 'll-tools-text-domain'), count($hidden_categories))); ?>">
                            ...
                            <span class="ll-wordset-link-chip__count" data-ll-wordset-hidden-count><?php echo (int) count($hidden_categories); ?></span>
                        </a>
                        <a class="ll-wordset-progress-mini" href="<?php echo esc_url($progress_url); ?>" aria-label="<?php echo esc_attr__('Open progress', 'll-tools-text-domain'); ?>">
                    ...
                    <div class="ll-wordset-next-shell" data-ll-wordset-next-shell>
                        <button type="button" class="ll-wordset-next-card" data-ll-wordset-next aria-live="polite">
                            <span class="ll-wordset-next-card__main">
                                ...
                                <span class="ll-wordset-next-card__preview" data-ll-wordset-next-preview aria-hidden="true">
                                    <span class="ll-wordset-next-thumb ll-wordset-next-thumb--empty"></span>
                                    <span class="ll-wordset-next-thumb ll-wordset-next-thumb--empty"></span>
                                </span>
            ...
            <?php else : ?>
                <div class="ll-wordset-grid-tools">
                    <button type="button" class="ll-wordset-select-all" data-ll-wordset-select-all aria-pressed="false">
            ...
            <div class="ll-wordset-selection-bar" data-ll-wordset-selection-bar hidden>
                ...
                <label class="ll-wordset-selection-bar__hard-toggle" aria-label="<?php echo esc_attr__('Hard words only', 'll-tools-text-domain'); ?>" hidden>
                    ...
                    <span class="ll-wordset-selection-bar__hard-icon" data-ll-wordset-selection-hard-icon aria-hidden="true">▲</span>
                ...
                <button type="button" class="ll-wordset-selection-bar__clear" data-ll-wordset-selection-clear><?php echo esc_html__('Clear', 'll-tools-text-domain'); ?></button>
            </div>
