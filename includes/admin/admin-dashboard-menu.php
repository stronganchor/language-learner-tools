...
if (!function_exists('ll_tools_get_dashboard_related_page_title_map')) {
    function ll_tools_get_dashboard_related_page_title_map(): array {
        return [
            ...
            'll-ipa-keyboard' => __('Transcription Keyboard', 'll-tools-text-domain'),
...
function ll_tools_render_tools_hub_page() {
    ...
    $workflow_links = [
        ...
        [
            'label' => __('Transcription Keyboard', 'll-tools-text-domain'),
            'description' => __('Review pronunciation text by word set and update recordings quickly.', 'll-tools-text-domain'),
