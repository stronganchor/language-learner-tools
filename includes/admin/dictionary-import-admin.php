...
function ll_tools_dictionary_import_get_job_snapshot(array $job): array {
    ...
    $advice_title = __('Keep This Tab Open', 'll-tools-text-domain');
    $advice_text = __('Keep this tab open while the import runs. Temporary connection drops will retry automatically. If you close the tab, reopen this screen to continue from the last saved batch.', 'll-tools-text-domain');
    if ($status === 'completed') {
            ...
            <table class="form-table" role="presentation">
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e('Expected columns: entry, definition, gender_number, entry_type, parent, needs_review, page_number. Header-based TSVs can also include translation_is_ai, part_of_speech_slug, pos_slug, source_id, source_dictionary, source_attribution_text, source_attribution_url, source_default_dialects, source_row_idx, raw_headword, title_keys, dialect, dialects, FLEx columns like headword_zza, all_forms_zza, sense_guid, part_of_speech_abbr_tr, part_of_speech_tr, examples_zza, example_translations_tr, semantic_domains, source_entry, and multilingual gloss columns like definition_full_tr, definition_tr, gloss_tr, reversal_tr, translation_en, and definition_full_de.', 'll-tools-text-domain'); ?>
                        </p>
                        <p class="description">
