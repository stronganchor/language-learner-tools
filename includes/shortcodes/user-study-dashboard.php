            ...
            <div class="ll-study-card ll-study-wordset-card">
                ...
                <div class="ll-star-mode">
                    ...
                    <div class="ll-star-toggle-group" data-ll-star-mode>
                        <button type="button" class="ll-study-btn tiny active" data-mode="normal"><?php echo esc_html__('Normal', 'll-tools-text-domain'); ?></button>
                        <button type="button" class="ll-study-btn tiny" data-mode="weighted"><?php echo esc_html__('Starred (2x)', 'll-tools-text-domain'); ?></button>
