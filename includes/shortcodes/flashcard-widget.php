...
function ll_flashcards_get_messages(): array {
    return [
        ...
        'genderLevelOneDoneMessage' => __('Move on to easier practice with the same words.', 'll-tools-text-domain'),
        ...
        'genderLevelTwoRetryMessage' => __('Repeat this level until answers come before the intro cue.', 'll-tools-text-domain'),
