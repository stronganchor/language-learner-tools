...
require_once __DIR__ . '/lib/word-translations.php';
...
require_once __DIR__ . '/lib/image-match-index.php';
...
require_once(__DIR__ . '/lib/public-static-cache.php');
...
require_once __DIR__ . '/lib/flashcard-payload-materializer.php';
...
require_once(__DIR__ . '/pages/wordset-transcription-review.php');
...
require_once(__DIR__ . '/lib/recording-history.php');
