...
| Quiz pages, flashcards, practice/learning/listening modes, option labels, embed routes, durable catalog or payload warmup | `public-quiz-flashcards` | `flashcard_widget`, `ll_get_flashcard_payload_page`, `ll_get_words_by_category`, `flashcard-payload-materializer`, `wp_ll_flashcard_payload_rows`, `flashcard payload cursor`, `cache_warming`, `restart_required`, `flashcard bootstrap`, `llToolsFlashcardsData`, `llToolsFlashcardsMessages`, `continuous filtered session`, `pre-results continuation`, `word-option-rules`, `quiz-page-template`, `quiz catalog`, `catalog warmup`, `ll_quiz_pages_catalog_warmup` |
| Wordset landing pages, sparse category shells, multi-category progress-filtered launches, staff pending-transcription search, word grid, bounded ranked-word lists, editor rows, vocab lesson shells/cards or large lesson paging, recorder queue overview/settings, category ordering/prerequisite settings | `wordset-vocab-manager` | `wordset-pages`, `wordset-editor`, `word-grid`, `ll_user_study_selection_launch_plan`, `bounded selection plan`, `continuous filtered session`, `pre-results continuation`, `selectionLaunchError`, `ll_ranked_word_list`, `_ll_tools_word_rank`, `ranked-word-list-shortcode`, `vocab-lesson`, `ll_tools_get_vocab_lesson_grid`, `vocab lesson grid cursor`, `staff order materialization`, `ll_tools_vocab_lesson_grid_paged_response`, `effective image aggregate`, `wordset-owned image copy`, `ll_tools_effective_word_image_presence_sql`, `recording_text`, `data-ll-expected-card-count`, `sparse category registry`, `ID-only lazy shell`, `advanced settings summary`, `category ordering`, `category prerequisites`, `ll_tools_wordset_save_category_ordering_settings`, `saved progress sort`, `saved recent sort`, `summaryCountsDeferred`, `ll_tools_wordset_page_get_server_main_sort`, `recorder queue summary`, `recorder summary generation`, `ll_tools_wordset_page_get_recorder_queue_summary_generation`, `ll_tools_recorder_queue_summaries`, `ll_tools_wordset_recorder_queue_summaries`, `queue_cursor`, `cursor_rebased`, `reset_queue`, `continuation_unavailable`, `page_items`, `is_continuation`, `has_more`, `pendingCategoryQueuePageRequest`, `lazy`, `paged`, `429` |
