...
| Wordset landing pages, category shells, search, word grid, editor rows, vocab lesson cards, recorder queue overview/settings | `wordset-vocab-manager` | `wordset-pages`, `wordset-editor`, `word-grid`, `vocab-lesson`, `sparse category registry`, `ID-only lazy shell`, `advanced settings summary`, `saved progress sort`, `saved recent sort`, `summaryCountsDeferred`, `ll_tools_wordset_page_get_server_main_sort`, `recorder queue summary`, `ll_tools_wordset_recorder_queue_summaries`, `queue_cursor`, `cursor_rebased`, `reset_queue`, `continuation_unavailable`, `page_items`, `is_continuation`, `has_more`, `pendingCategoryQueuePageRequest`, `lazy`, `paged` |
