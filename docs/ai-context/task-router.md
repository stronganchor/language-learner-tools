...
| Wordset landing pages, category shells, staff pending-transcription search, word grid, editor rows, vocab lesson shells/cards, recorder queue overview/settings | `wordset-vocab-manager` | `wordset-pages`, `wordset-editor`, `word-grid`, `vocab-lesson`, `recording_text`, `data-ll-expected-card-count`, `saved progress sort`, `saved recent sort`, `summaryCountsDeferred`, `ll_tools_wordset_page_get_server_main_sort`, `recorder queue summary`, `ll_tools_recorder_queue_summaries`, `queue_cursor`, `cursor_rebased`, `reset_queue`, `continuation_unavailable`, `page_items`, `is_continuation`, `has_more`, `pendingCategoryQueuePageRequest`, `lazy`, `paged` |
...
| Wordset-isolation migration, category ownership/remapping, migration retry/status/CLI | `core-runtime-data-model` | `wordset-isolation`, `LL_TOOLS_WORDSET_ISOLATION_CURRENT_MIGRATION_VERSION`, `LL_TOOLS_WORDSET_ISOLATION_MIGRATION_STATE_OPTION`, `LL_TOOLS_USER_RECOMMENDATION_DEFERRALS_META`, `LL_TOOLS_USER_PROMPT_CARD_PROGRESS_META`, `wordset-isolation-migrate`, `allow-large-option-rules`, `ll_tools_wordset_isolation_continue_migration` |
| Performance fixtures, benchmark scenarios, page-speed budgets, large-wordset evidence, expired transient or wp_options cache cleanup | `performance-benchmark` | `PERFORMANCE_ARCHITECTURE`, `LL_PERF_PROFILE`, `LL_PERF_SKIP_SEED`, `canonical-json-v1`, `LL_E2E_PERF_CONFIG_LOCKED`, `verify-performance-manifest`, `performance-history`, `page-speed`, `large-wordset`, `expired-transient-maintenance` |
