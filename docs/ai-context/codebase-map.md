...
| Recorder, upload, processing, transcription | `includes/shortcodes/audio-recording-shortcode.php`, `includes/lib/recording-history.php`, `includes/pages/wordset-transcription-review.php`, `includes/admin/uploads/`, `includes/admin/audio-processor-admin.php`, `includes/admin/ipa-keyboard-admin.php`, `js/audio-recorder.js`; [frontend tools](../FRONTEND_RECORDING_TOOLS.md) | `RecordingHistoryTest.php`, `WordsetTranscriptionReviewTest.php`, `AudioUploadMetadataPreservationTest.php`, `IpaKeyboardAdminAjaxTest.php`, `SecurityHardeningRegressionTest.php`, `recording-history.spec.js`, `wordset-transcription-review.spec.js`, `audio-processor-delete-all.spec.js` |
| Copy/Split Word | `includes/lib/word-copy.php`, `includes/pages/wordset-editor.php`, `js/word-copy-dialog.js`; [frontend tools](../FRONTEND_RECORDING_TOOLS.md) | `WordCopySplitTest.php`, `SplitWordReturnFlowTest.php`, `word-copy-dialog.spec.js` |
...
| Recording text and review write serialization | `includes/lib/recording-metadata.php`; `ll_tools_recording_write_run`, `ll_tools_recording_update_post_meta` | `RecordingMetadataWriteTest.php`, `WordsetTranscriptionReviewTest.php`, `IpaKeyboardAdminAjaxTest.php`; see [frontend tools](../FRONTEND_RECORDING_TOOLS.md) |
